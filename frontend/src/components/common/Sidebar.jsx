...
import { 
  ...
  ChevronRight, LogOut, Briefcase, PlusCircle 
} from 'lucide-react';
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 border-r border-white/5 bg-[#0d1321] flex flex-col h-screen overflow-y-auto shrink-0 select-none">
      {/* Brand Header */}
      <div className="h-16 px-6 border-b border-white/5 flex items-center gap-2.5">
        <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-accentPurple to-accentIndigo flex items-center justify-center font-bold text-white shadow-md">TF</div>
      ...
      <div className="p-4 border-t border-white/5 mt-auto bg-[#090e18]">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-full bg-accentIndigo/30 flex items-center justify-center font-bold text-accentIndigo text-sm border border-accentIndigo/45">
